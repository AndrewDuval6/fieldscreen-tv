import { gamePriority, gameLabel, gameCoverage, matchBroadcasts, liveBroadcast, resolveSelectedGame } from './mlb-core.mjs';
...
function current() { return resolveSelectedGame(games(), state.selected, state.detail); }
