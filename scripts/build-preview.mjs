...
await writeFile(new URL('pane-runtime.js', output), '(()=>{\n' + await readFile(new URL('./pane-runtime.mjs', import.meta.url), 'utf8') + '\n})();');
...
const nflCore = (await readFile(new URL('./nfl-core.mjs', import.meta.url), 'utf8')).replace(/^export /gm, '');
const nflRuntime = (await readFile(new URL('./nfl-runtime.mjs', import.meta.url), 'utf8')).replace(/^import .*;\n/, '');
await writeFile(new URL('nfl-runtime.js', output), '(()=>{\n' + nflCore + '\n' + nflRuntime + '\n})();');
...
<body>${source}<script src="./preview.js"></script><script src="./hls.min.js"></script><script src="./mpegts.js"></script><script src="./iptv-runtime.js"></script><script src="./nfl-runtime.js"></script><script src="./pane-runtime.js"></script><script src="./tv-runtime.js"></script></body></html>`);
console.log('Built FieldScreen TV with ESPN NFL data, nflverse statistics, IPTV, XMLTV, and controller support.');
