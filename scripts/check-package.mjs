...
for (const entry of ['/main.cjs', '/preload.cjs', '/iptv.cjs', '/vault.cjs', '/favorites.cjs', '/licenses/saxes-LICENSE.txt', '/licenses/xmlchars-LICENSE.txt']) assert(entries.includes(entry), `Packaged app is missing ${entry}`);
