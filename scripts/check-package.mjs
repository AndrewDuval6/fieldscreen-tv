...
for (const file of ['index.html', 'preview.js', 'preview.css', 'iptv-runtime.js', 'nfl-runtime.js', 'mlb-runtime.js', 'sports-runtime.js', 'favorites-runtime.js', 'hls.min.js', 'mpegts.js', 'tv-runtime.js', 'pane-runtime.js', 'recorder-runtime.js', 'fieldscreen-mark.png', 'HLS-LICENSE.txt', 'MPEGTS-LICENSE.txt']) await access(prefix + file);
