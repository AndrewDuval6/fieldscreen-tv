...
function director() {
  ...
  q('#ez-dir-moments').innerHTML = btn('Watch game ↗', `data-nfl-watch="${game.id}"`) + btn('Game details', `data-nfl-detail="${game.id}"`) + btn('Full schedule', 'data-nfl-view="schedule"');
